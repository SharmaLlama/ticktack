...
class CarbonBoxModel:
    ...
    def derivative(self, production, steady_state_production, y, t, args):
        """
        The rate of change of the box concentrations with respect to time. 

        Parameters
        ----------
        production : CompiledFunction
            The production model of the system
        steady_state_production : DeviceArray
            The production rate matching the equilibrium position of the system
        y : DeviceArray
        ...
        Returns
        DeviceArray
            The box contents at the next time interval
        """
    ...
    def run(self, time, production, y0=None, args=(), target_C_14=None, steady_state_production=None, solution=None):
        ...
        derivative = lambda y, t: self.derivative(production, steady_state_production, y, t, args)
