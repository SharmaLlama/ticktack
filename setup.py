...
setup(name='ticktack',
      ...
      packages=['ticktack'],
      package_data={'': ['data/*.hd5', 'data/datasets/660BCE_Ew/*.csv', 'data/datasets/660BCE_Lw/*.csv',
                         'data/datasets/775AD early/*.csv',
                         'data/datasets/775AD late/*.csv',
                         'data/datasets/993AD/*.csv',
