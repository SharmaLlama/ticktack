...
setup(name='ticktack',
      ...
      packages=['ticktack'],
      package_data={'': ['data/*.hd5', 'data/datasets/660BCE/NH/*.csv',
                         'data/datasets/775AD/NH/*.csv', 'data/datasets/775AD/SH/*.csv',
                         'data/datasets/993AD/NH/*.csv', 'data/datasets/993AD/SH/*.csv',
                         'data/datasets/5259BCE/NH/*.csv', 'data/datasets/5410BCE/NH/*.csv',
                         'data/datasets/7176BCE/NH/*.csv'
                         ]},
